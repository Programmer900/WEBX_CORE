    ...
    <div class="right-panel">
      ...
      <div class="right-panel-body has-slimscroll">
        <div class="languages-boxes">
          ...
          <div class="language-box">
            <div class="language-option" style="opacity: .3">
          ...
          <div class="language-box">
            <div class="language-option" style="opacity: .3">
              <!--<input v-model="locale" type="radio" name="language_selection" value="de" disabled="disabled" />-->
              <div class="language-option-inner">
                <img src="/images/icons/flags/germany.svg" alt="" disabled="disabled" />
                <div class="indicator">
                  <i aria-hidden="true" class="iconify" data-icon="feather:check"></i>
                </div>
              </div>
