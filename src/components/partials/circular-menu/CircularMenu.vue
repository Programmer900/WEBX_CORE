...
<template>
  ...
  >
    ...
    >
      ...
      <span v-if="isOpen"><i class="iconify" data-icon="feather:eye-off" aria-hidden="true"></i></span>
      <span v-else><i class="iconify" data-icon="feather:eye" aria-hidden="true"></i></span>

      <!--<i class="iconify" data-icon="feather:chrome" aria-hidden="true"></i>-->
      <!--<i class="iconify" data-icon="feather:triangle" aria-hidden="true"></i>-->
    </a>
