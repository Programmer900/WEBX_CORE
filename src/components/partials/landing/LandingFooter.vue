  ...
  <footer class="vuero-footer">
    <div class="container">
        ...
        <div class="column is-4">
          ...
          <div>
            <span class="moto">
              ...
              by WEBX GROUP Development</span
            >
          ...
          <div class="columns is-flex-tablet-p">
            ...
            <div class="column">
              <ul class="footer-column">
                <li class="column-header">WEBX GROUP Ecosystem</li>
      ...
      <div class="footer-copyright has-text-centered">
        <p>
          <span role="img" aria-label="copyright">&copy;</span> 2022 |
          <a to="/">WEBX GROUP</a> | All Rights Reserved.
        </p>
      </div>
    </div>
  </footer>
