...
const handleSignup = async () => {
  if (!isLoading.value) {
    ...
    notif.dismissAll()
    notif.success('Welcome, Anton Chernenko')
...
<template>
  <div>
    <div class="signup-nav">
      <!--<div class="signup-nav-inner" style="padding: 20px 0;">
        <RouterLink :to="{ name: 'index' }" class="logo">
          <AnimatedLogoText width="180px" height="180px" />
        </RouterLink>
      </div>-->
    </div>
          ...
          <div class="container">
                      ...
                      <div class="column is-6">
                        <VField>
                          <VControl>
                            ...
                            <div class="auth-label">{{ t('auth.form.placeholders.name') }}</div>
                          </VControl>
                        </VField>
                      </div>
                      <div class="column is-6">
                        <VField>
                          <VControl>
                            ...
                            <div class="auth-label">{{ t('auth.form.placeholders.last_name') }}</div>
                          </VControl>
                        </VField>
                      </div>
                      <div class="column is-12">
                        <VField>
                          <VControl>
                            ...
                            <div class="auth-label">{{ t('auth.form.placeholders.email') }}</div>
                          </VControl>
                        </VField>
                      </div>
                      <div class="column is-12">
                        <div class="signup-type">
                          <div class="box-wrap">
                            ...
                            <div class="signup-box">
                              ...
                              <div class="meta">
                                <span>{{ t('auth.form.placeholders.rate.free') }}</span>
                                <span>{{ t('auth.form.placeholders.rate.free_text') }}</span>
                              </div>
                            </div>
                          </div>
                          <div class="box-wrap">
                            ...
                            <div class="signup-box">
                              ...
                              <div class="meta">
                                <span>{{ t('auth.form.placeholders.rate.paid') }}</span>
                                <span>{{ t('auth.form.placeholders.rate.paid_text') }}</span>
                              </div>
                            </div>
                          </div>
                        </div>
            ...
            <div class="columns signup-columns" :class="[step !== 1 && 'is-hidden']">
              <form class="column is-8" @submit.prevent>
                ...
                <div class="button-wrap is-centered has-text-centered">
                  <VIconButton color="#ccc" light raised circle icon="feather:arrow-left" />
            ...
            <div class="columns signup-columns" :class="[step !== 2 && 'is-hidden']">
              <div class="column is-4 is-offset-4 username-form">
                ...
                <h2 class="subtitle signup-subtitle has-text-centered">
                  Your username is how others will find you on WEBX GROUP so pick a good one.
...
html:not(.is-dark) .signup-wrapper {
