...
const handleLogin = async () => {
  if (!isLoading.value) {
    ...
    notif.dismissAll()
    notif.success('Welcome back, Anton Chernenko')*/
...
useHead({
  title: 'WEBX GROUP Ecosystem | Log In',
})
</script>
        ...
        <div class="is-form">
          <div class="hero-body">
            <div class="form-text" :class="[step !== 'login' && 'is-hidden']">
              ...
              <p>Welcome back to your account | WEBX GROUP</p>
            </div>
            <div class="form-text" :class="[step === 'login' && 'is-hidden']">
            ...
            >
              ...
              <div class="button-wrap">
                <VButton disabled color="white" size="big" lower rounded @click="step = 'login'">
                  Cancel
                </VButton>
                <VButton
                  color="primary"
